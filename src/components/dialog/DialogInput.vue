<template>
    <div class="fixed top-0 left-0 w-full flex justify-center overflow-hidden" :class="open ? 'z-[2] h-full' : 'z-[-2] h-0'">
        ...
        <div class="fixed bottom-0 rounded-3xl h-[85vh] md:h-[95vh] w-[28%] min-w-[350px] max-w-[450px] mb-18 md:mb-5 p-7 duration-300" :class="!open ? '' : (store().theme == 'dark' ? 'dark animate__animated animate__fadeInUp animate__faster mb-4 duration-400' : 'bg-white animate__animated animate__fadeInUp animate__faster mb-4 duration-400')">
