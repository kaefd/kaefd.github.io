...
export default {
    data() {
        return {
            config: {
                ...
                fields: {
                    head: [
                        {title: 'No Pengeluaran', key: 'no_penjualan', type: 'text', show: true, read: {show: true, disabled: true}, create: {show: true, disabled: true}, column: true, sort: 'desc' },
                        ...
                        {title: 'Status', key: 'status', type: 'text', show: true, read: {show: false, disabled: true}, create: {show: false, disabled: false}, column: true, sort: 'desc'},
                    ],
                    detail: [
                        {title: 'Kode Barang', key: 'kode_barang', type: 'text', read: {show: true, disabled: true}, create: {show: true, disabled: false}, column: true, dialog: true,},
    ...
    methods: {
        async get() {
            const check = otoritas.check('Laporan Penjualan')
