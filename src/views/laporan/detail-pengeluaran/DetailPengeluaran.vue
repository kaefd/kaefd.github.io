            ...
            config: {
                ...
                fields: {
                    head: [
                        ...
                        {title: 'Kode Group', key: 'kode_group', type: 'text', show: true, read: {show: false, disabled: true}, column: true, sort: 'desc'},
                    ...
                    detail: [
                        {title: 'No Pengeluaran', key: 'no_penjualan', type: 'text', read: {show: true, disabled: true}, column: true, sort: 'desc'},
