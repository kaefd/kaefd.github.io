...
import PengirimanDetail from '@/views/transaksi/pengiriman/PengirimanDetail.vue'
...
export default {
    ...
    methods: {
        async get () {
            ...
            if(a) {
                store().loader('on')
                let data = await pengiriman.pengiriman(null, this.config.fields[0])
...
</script>@/views/transaksi/pengiriman/pengiriman