                    ...
                    // if(detail[i].jenis_otoritas == 'Laporan') {
                        {
                            ...
                            item: [
                                ...
                                {title: 'Laporan Bc', key: 'laporan_bc', value: detail.find(it => it.jenis_otoritas == 'Laporan Bc' && it.username == head[i].username) == undefined ? 'false' : detail.find(it => it.jenis_otoritas == 'Laporan Bc' && it.username == head[i].username).status},
