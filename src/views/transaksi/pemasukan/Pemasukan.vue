            ...
            config: {
                ...
                fields: {
                    head: [
                        ...
                        { title: 'Supplier', key: 'supplier', type: 'dialog', item: {point: 'nama', key: 'kode_supplier', endpoint: 'supplier', title: 'Data Supplier', child: false, left: ['nama']}, show: true, read: {show: true, disabled: true}, create: {show: true, disabled: false}, column: true, dialog: false, sort: 'desc' },
                        ...
                        { title: 'No BL', key: 'no_bl', type: 'text', show: false, read: {show: true, disabled: true}, create: {show: true, disabled: false}, column: false, dialog: false, sort: 'desc' },
                        ...
                        { title: 'Total Nilai', key: 'total_nilai', type: 'number', show: true, read: {show: false, disabled: true}, create: {show: false, disabled: false}, column: true, dialog: false, sort: 'desc' },
                        ...
                        { title: 'Total Nilai(Rp)', key: 'rupiah', type: 'number', show: true, read: {show: false, disabled: true}, create: {show: false, disabled: false}, column: true, dialog: false, sort: 'desc' },
                    ],
                    detail: [
